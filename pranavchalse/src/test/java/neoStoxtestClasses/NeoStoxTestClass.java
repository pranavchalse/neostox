...
import neostoxPomClasses.NeoStoxBaseClass;
...
import neostoxPomClasses.NeoStoxUtilityClass;
import neostoxPomClasses.NeoStoxWelcomePage;

@Listeners(neostoxPomClasses.Listener.class)
public class NeoStoxTestClass extends NeoStoxBaseClass{
	...
	@Test(priority = -1)
	public void getfund() throws IOException, InterruptedException
	{
