...
public class Utility 
{
	 ...
	 { 
		 TCID=RandomString.make(2);
	 	 File src = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE); 
	 	 File dest= new File("C:\\selinium\\ss\\"+TCID+".jpeg"); 
	 ...
	 public static String ReadDataFromPropertyFile(String key) throws IOException
	 {
		 ...
		 FileInputStream myfile=new FileInputStream("C:\\Users\\chals\\eclipse-workspace\\Selenium\\property.properties");
		 prop.load(myfile);
