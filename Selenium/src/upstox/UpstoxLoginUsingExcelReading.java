...
public class UpstoxLoginUsingExcelReading {
	...
	public static void main(String[] args) throws IOException 
	{
		...
		//entering login id 
		driver.findElement(By.id("userCode")).sendKeys(Excel.excelread(0, 0));
		
		driver.manage().timeouts().implicitlyWait(Duration.ofMillis(500));
		//entering password
		driver.findElement(By.name("password")).sendKeys(Excel.excelread(0, 1));
		...
		driver.findElement(By.id("yob")).sendKeys(Excel.excelread(0, 2));
		...
		System.out.println(Excel.excelread(0, 0));
	}
